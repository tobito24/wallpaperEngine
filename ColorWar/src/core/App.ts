...
import { ColorSimulation } from '../simulation/ColorSimulation';
import { attachTileClickControls } from '../simulation/tileClickControls';
...
export class App {
  ...
  private readonly colorSimulation = new ColorSimulation();
  ...
  private update(dt: number): void {
    ...
    this.colorSimulation.update(dt * 1000, this.world);
  }
  ...
  private renderDebugHud(): void {
    ...
    this.ctx.fillText(`tick interval: ${this.colorSimulation.tickIntervalMs}ms`, 8, 64);
